...
/**
 * 매주 월요일 16:00(KST): 만남 가능 일정 화~일 6일(`meetingStartsAt`의 KST 날짜)에 해당하는 매칭만 대상.
...
function scheduleMatchSuccessFriendTalkCron() {
  ...
  console.log(
    '[matchSuccessFriendTalkCron] 등록됨: 매주 월요일 16:00 Asia/Seoul — 만남일(KST 화~일 6일) 기준 1:1 성공 + 소그룹 참석 초대',
  );
}
